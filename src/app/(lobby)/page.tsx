...
export default function Home() {
  return (
    <Shell className="gap-14">
      <section
        id="hero"
        className="mx-auto flex w-full max-w-[64rem] flex-col items-center justify-center gap-4 pt-6 text-center md:pt-10 lg:py-10"
      >
        <h1
        ...
        <p className="max-w-[46rem] font-normal text-muted-foreground md:text-xl">
          <Balancer>
